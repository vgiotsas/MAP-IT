    ...
    with TraceReader(filename) as f:
        for line in f:
            if isinstance(line, list):
                # the file contains a list of traceroutes
                for trace in line:
                    process_trace(trace, addresses, adjacencies)
            else:
                # the file contains one traceroute per line
                process_trace(line, addresses, adjacencies)
